...
public:
    ...
    [[nodiscard]] int attackDamage() const override { return 50; }
    ...
    [[nodiscard]] std::unique_ptr<Enemy> clone() const override { return std::make_unique<LongRangeHighDamageEnemy>(*this); }
